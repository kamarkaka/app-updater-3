        ...
        <div className="grid grid-cols-2 gap-4">
          <label className="block">
            ...
            <select
              ...
              className="mt-1 block w-full rounded bg-gray-800 border border-gray-700 px-3 py-2.5 text-white focus:outline-none focus:border-blue-500"
            >
              {SOURCE_TYPES.map((t) => (
          ...
          <label className="block">
            <span className="text-sm text-gray-400">Check Interval (min)</span>
            <input
              type="number"
              value={checkInterval}
